...
State
{
    ...
    OnToggleEvent
	{
		...
		OnActions = 
		{
			BuildingTeamTransfer{Tag = "RealTower05", Team = "tm_FriendlyTowers"},
		...
		OffActions = 
		{
			BuildingTeamTransfer{Tag = "RealTower05", Team = "tm_NeutralTowers"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			DialogSetDisabled{},
			FogOfWarRevealAtEntity	{FogOfWarId = 55, Tag = "RealTower05", Range = 10, Height = default},
		},
	},
