...
State
{
    ...
    OnToggleEvent
	{
		...
		OnActions = 
		{
			BuildingTeamTransfer{Tag = "RealTower07", Team = "tm_FriendlyTowers"},
		...
		OffActions = 
		{
			BuildingTeamTransfer{Tag = "RealTower07", Team = "tm_NeutralTowers"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			DialogSetDisabled{},
			FogOfWarRevealAtEntity	{FogOfWarId = 77, Tag = "RealTower07", Range = 10, Height = default},
		},
	},
