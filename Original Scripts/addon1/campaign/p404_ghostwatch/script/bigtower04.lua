...
State
{
    ...
    OnToggleEvent
	{
		...
		OnActions = 
		{
			BuildingTeamTransfer{Tag = "BigRealTower04", Team = "tm_FriendlyTowers"},
		...
		OffActions = 
		{
			BuildingTeamTransfer{Tag = "BigRealTower04", Team = "tm_NeutralTowers"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			DialogSetDisabled{},
			FogOfWarRevealAtEntity	{FogOfWarId = 104, Tag = "BigRealTower04", Range = 10, Height = default},
		},
	},
