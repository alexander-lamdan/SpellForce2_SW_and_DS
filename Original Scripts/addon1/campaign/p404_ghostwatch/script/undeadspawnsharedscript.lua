...
CoordSpawnBuilding =
{
	Skeleton = { X = 142.645, Y = 402.394, },   -- HIER MÜSSEN RICHTIGE KOORDINATEN HIN            
	Stalker = { X = 131.001, Y = 397.924, },    -- SOBALD SIDONIE DIE GEBÄUDE RICHTIG PLAZIERT HAT 
	Terror = { X = 123.218, Y = 406.621, },     -- HIER MÜSSEN RICHTIGE KOORDINATEN HIN            
	Cryptlord = { X = 150.64, Y = 388.426, },   -- SOBALD SIDONIE DIE GEBÄUDE RICHTIG PLAZIERT HAT 
}
