...
State
{
    ...
    OnToggleEvent
	{
		...
		OnActions = 
		{
			BuildingTeamTransfer{Tag = "RealTower04", Team = "tm_FriendlyTowers"},
		...
		OffActions = 
		{
			BuildingTeamTransfer{Tag = "RealTower04", Team = "tm_NeutralTowers"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			DialogSetDisabled{},
			FogOfWarRevealAtEntity	{FogOfWarId = 44, Tag = "RealTower04", Range = 10, Height = default},
		},
	},
