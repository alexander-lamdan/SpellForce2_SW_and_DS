...
State
{
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			FigureVanish {Tag = "Dummy_CS_03_Double01"},
		},
	},
	OnCutsceneFigureRespawnEvent	-- 
	{
		...
		Actions =
		{
			...
			CutsceneFigureTeleport {Tag = "pl_HumanAvatar", X = 205.611, Y = 557.07},
			FigureLookAtDirection {Tag = "pl_HumanAvatar", Direction = 170},
			--CutsceneFigureTeleport {Tag = "FormerDouble", X = 197.095, Y = 561.674},
			--FigureLookAtDirection {Tag = "FormerDouble", Direction = 90},
			-- Waffen werden nicht dargestellt
			CutsceneFigureWeaponsHide {Tag = "pl_HumanAvatar"},
			CutsceneFigureWeaponsHide {Tag = "FormerDouble"},
			-- Talkjobs werden gesetzt
			FigureCutsceneTalkJobSet {Tag = "pl_HumanAvatar"},
			-- Drache und Former werden gespawnt
			MapFlagSetTrue {Name = "mf_CS_03_Dragon_Talking_Spawn"},
			MapFlagSetTrue {Name = "mf_CS_03_Former_Spawn"},
			-- CS_Former wird gespawnt
			NoSpawnEffect {Spawn = FigureNpcSpawn {Tag = "CS_FormerDouble", Level = 1, UnitId = 1078, X = 197.095, Y = 561.674, Team = "tm_Neutral"},},
			-- Effekt auf Teleporter
			EffectStart {Tag = "EndPortal", File = "Effect_Spawn_Gate"},
...
State
{
	...
	OnOneTimeEvent	-- Former Double kippt um
	{
		Conditions =
		{
			--CutsceneSayIsDone {},
		...
		Actions =
		{
			FigureKill {Tag = "CS_FormerDouble"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Avatar09
	{
		...
		Actions =
		{
			...
			FigureLookAtDirection {Tag = "default", Direction = 260},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Seelentraeger04 
	{
		Conditions =
		{
			CutsceneSayIsDone {},
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "Seelentraeger04", Tag = "CS_03_Dragon_Talking"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Former rennt durchs Portal
	{
		Conditions =
		{
			CutsceneSayIsDone {},
		...
		Actions =
		{
			FigureSimpleRun {Tag = "CS_03_Former", X = 155.329, Y = 585.889},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Avatar10 & Former verschwindet
	{
		Conditions =
		{
			--CutsceneSayIsDone {},
			FigureIsIdle {Tag = "CS_03_Former"},
			--FigureIsInRange--{Tag = "", Range = , X = , Y = },
			--EntityTimerIsElapsed {Name = "et_CStimer", Seconds = 5},
		},
		Actions =
		{
			FigureVanish {Tag = "CS_03_Former"},
...
State
{
	...
	OnOneTimeEvent	-- Seelentraeger05
	{
		Conditions =
		{
			CutsceneSayIsDone {},
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "Seelentraeger05", Tag = "CS_03_Dragon_Talking"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Seelentraeger06
	{
		Conditions =
		{
			CutsceneSayIsDone {},
		...
		Actions =
		{
			CutsceneSay {TextTag = "Seelentraeger06", Tag = "CS_03_Dragon_Talking"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Seelentraeger07
	{
		Conditions =
		{
			CutsceneSayIsDone {},
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "Seelentraeger07", Tag = "CS_03_Dragon_Talking"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnCutsceneFigureDespawnEvent
	{
		...
		Actions =
		{
			...
			FigureVanish {Tag = "CS_03_Dragon_Talking"},
			-- Drachen wird an Dummy-Position gespawnt
			CutsceneFigureTeleport {Tag = "pl_HumanUr", X = 210.808, Y = 564.452},
			FigureLookAtDirection {Tag = "pl_HumanUr", Direction = 260},
			-- Effekt auf Portal wird gestoppt
			EffectStop {Tag = "EndPortal"},
			-- scritpingrelevante Flags
