...
--Ponytrack Nummer 01 Nachhut 2 (Rechtsfuss)
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track1Rider8", Range = 5},
	...
	Points = 
	{
		...
		--{Point = "08RStartPathPoint", WaitTime = 0, Range = 3},
        ...
        {Point = "PathPoint10r",},
        {Point = "PathPoint11r",},
        {Point = "Track1Stop16", WaitTime = 10},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "08RStartPathPoint", Range = 5},
			--MapFlagIsTrue	{Name = "mf_ResetTrack01"}, 
		},
	}, 
	StopActions = 
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track1Pony6", WaitTime = 0, Range = 3},
        ...
        {Point = "PathPoint13r",},
        {Point = "PathPoint12r",},
        {Point = "Track1_2Stopp16", WaitTime = 10},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track1Stop16", Range = 5},
			--MapFlagIsTrue	{Name = "mf_ResetTrack01"}, 
		},
	}, 
	StopActions = 
...
PathStates	
{
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track1Stop12", WaitTime = 0, Range = 3},
...
{	
	...
	OnEvent
	{
		Conditions =
		{
			...
			MapFlagIsFalse {Name = "mf_FollowStart"},
			FigureIsInEntityRange	{TargetTag = "Track1Rider8", Range = 15},
			--MapFlagIsFalse	{Name = "mf_Camp05Destroyed"}, 
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			...
			--MapFlagIsFalse	{Name = "mf_ResetTrack01"},
			MapFlagIsFalse {Name = "mf_FollowStart"},
			FigureIsInEntityRange	{TargetTag = "08RStartPathPoint", Range = 15},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			...
			--MapFlagIsFalse	{Name = "mf_ResetTrack01"},
			MapFlagIsFalse {Name = "mf_FollowStart"},
			FigureIsInEntityRange	{TargetTag = "Track1Stop16", Range = 15},
		},
		Actions =
		{
...
{	
	...
	OnEvent
	{
		Conditions =
		{
			MapTimerIsElapsed	{Name = "mt_FollowStartTimer", Seconds = 2.4},
