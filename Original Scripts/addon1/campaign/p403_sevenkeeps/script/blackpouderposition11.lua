--BlackPouderPosition
BarrelPosition01X = 547.4
BarrelPosition01Y = 516.6
BombJack = 1061
...
{	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2253, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 0, Tag = "Barrel11"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2213, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 45, Tag = "Bomb11"},
			VisualTimerStart	{Seconds = 4},
			AvatarItemMiscTake	{Player = "pl_Human", ItemId = 283, Amount = 1},
			MapFlagSetTrue{Name = "mf_Bomb11set"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectChange	{Tag = "Bomb11", ObjectId = 2212, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 45},
			EntityFlagSetTrue {Name = "ef_BombExplode1"},
		},	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			BuildingHealthSet	{Tag = "Camp01", Percent = 10},
		},	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			MapFlagSetFalse{Name = "mf_Bomb11set"},
		},	
