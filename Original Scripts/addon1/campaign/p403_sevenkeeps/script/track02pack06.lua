...
PathStates	
{
	...
	Conditions = 
	{
		MapTimerIsElapsed	{Name = "mt_Track02StartSyncTimer", Seconds = 25},
	}, 
	Actions = 
	{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track2PathEndpoint12", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	Points = 
	{
		...
		--{Point = "Track2PathPointStart06", WaitTime = 0, Range = 3},
...
PathStates	
{
	...
	Conditions = 
	{
		MapTimerIsElapsed	{Name = "mt_Track02EndSyncTimer", Seconds = 25},
	}, 
	Actions = 
	{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track2PathPointStart06", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track2PathEndpoint08", WaitTime = 0, Range = 3},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track02CityWaitingPoint12", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	Points = 
	{
        ...
        {Point = "Track2PathPoint11r",},
        {Point = "Track2PathPoint12r",},
        {Point = "Track02CityWaitingPoint12",},
...
PathStates	
{
	...
	{
		DontTeleportToStartPosition = true,
        {Point = "Track02CityWaitingPoint08", WaitTime = 0, Range = 3},
...
{	
	...
	OnEvent
	{
		...
		{
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track2PathEndpoint12", Range = 15},
			--MapFlagIsFalse	{Name = "mf_Camp04Destroyed"}, 
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			MapFlagIsFalse	{Name = "mf_Camp04Destroyed"}, 
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track2PathPointStart06", Range = 15},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			MapFlagIsTrue	{Name = "mf_Camp04Destroyed"}, 
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track02CityWaitingPoint12", Range = 15},
		},
		Actions =
		{
...
{	
	...
	OnEvent
	{
		Conditions =
		{
			...
			--	FigureIsInEntityRange	{Tag = "Track02Lead", TargetTag = "SouthCamp", Range = 15},
			--},
			MapTimerIsElapsed	{Name = "mt_FollowTrack02StartTimer", Seconds = 3.9},
			FigureIsIdle	{},
