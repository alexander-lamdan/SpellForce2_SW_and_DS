--BlackPouderPosition
BarrelPosition01X = 607.6
BarrelPosition01Y = 520.8
BombJack = 1061
...
{	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2253, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 0, Tag = "Barrel06"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2213, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 145, Tag = "Bomb06"},
			EntityFlagSetTrue {Name = "ef_BombPlaced"},
			VisualTimerStart	{Seconds = 4},
			AvatarItemMiscTake	{Player = "pl_Human", ItemId = 283, Amount = 1},
			MapFlagSetTrue{Name = "mf_Bomb06set"},
		},	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectChange	{Tag = "Bomb06", ObjectId = 2212, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 145},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			MapFlagSetFalse{Name = "mf_Bomb06set"},
		},	
