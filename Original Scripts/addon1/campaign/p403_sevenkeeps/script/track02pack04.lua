...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track2PathEndpoint10", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	Points = 
	{
		...
		--{Point = "Track2PathPointStart04", WaitTime = 0, Range = 3},
        ...
        {Point = "Track02CityWaitingPoint10",WaitTime = 10},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track2PathPointStart04", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track2PathEndpoint06", WaitTime = 0, Range = 3},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track02CityWaitingPoint10", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	Points = 
	{
        ...
        {Point = "Track2PathPoint11r",},
        {Point = "Track2PathPoint12r",},
        {Point = "Track02CityWaitingPoint10",},
...
PathStates	
{
	...
	{
		DontTeleportToStartPosition = true,
        {Point = "Track02CityWaitingPoint06", WaitTime = 0, Range = 3},
...
{	
	...
	OnEvent
	{
		...
		{
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track2PathEndpoint10", Range = 15},
			--MapFlagIsFalse	{Name = "mf_Camp04Destroyed"}, 
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			MapFlagIsFalse	{Name = "mf_Camp04Destroyed"}, 
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track2PathPointStart04", Range = 15},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			MapFlagIsTrue	{Name = "mf_Camp04Destroyed"}, 
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track02CityWaitingPoint10", Range = 15},
		},
		Actions =
		{
