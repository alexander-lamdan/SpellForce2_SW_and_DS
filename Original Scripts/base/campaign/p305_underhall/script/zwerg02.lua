...
State
{
	...
	OnEvent
	{
		Conditions =
		{
			FigureIsInRange	{Range = 3, X = 286, Y = 324},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			FigureIsInRange	{Range = 3, X = 244, Y = 49},
		},
		Actions =
		{
	...
	OnOneTimeEvent
	{
		...
		{
			AvatarFlagIsTrue{Name = "af_P305_WindhammerQuestSolved"},
			FigureIsInRange	{Range = 2, X = 282, Y = 40},
		},
		Actions =
		{
