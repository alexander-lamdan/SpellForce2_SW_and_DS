...
State
{
	...
	OnEvent
	{
		Conditions =
		{
			FigureIsInRange	{Range = 3, X = 287, Y = 324},
		},
		Actions =
		{
	...
	OnOneTimeEvent
	{
		...
		{
			AvatarFlagIsTrue{Name = "af_P305_WindhammerQuestSolved"},
			FigureIsInRange	{Range = 2, X = 280, Y = 44},
		},
		Actions =
		{
