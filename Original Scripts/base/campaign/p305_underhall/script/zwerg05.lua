...
State
{
	...
	OnEvent
	{
		Conditions =
		{
			FigureIsInRange	{Range = 3, X = 285, Y = 324},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			FigureIsInRange	{Range = 3, X = 248, Y = 49},
		},
		Actions =
		{
	...
	OnOneTimeEvent
	{
		...
		{
			AvatarFlagIsTrue{Name = "af_P305_WindhammerQuestSolved"},
			FigureIsInRange	{Range = 2, X = 301, Y = 44},
		},
		Actions =
		{
