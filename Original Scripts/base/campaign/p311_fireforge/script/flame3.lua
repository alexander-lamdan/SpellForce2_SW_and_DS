...
State
{
	...
	OnOneTimeEvent
	{
		...
		Actions = 
		{
			ObjectChange	{Tag = "Flame3", ObjectId = 1109},
		},
	},
};
State
{
	...
	OnEvent
	{
		...
		Actions = 
		{
			ObjectChange	{Tag = "Flame3", ObjectId = 1111},
			MapFlagSetFalse {Name = "mf_ChangeFlame3"},
		},
	...
	OnEvent
	{
		...
		Actions = 
		{
			ObjectChange	{Tag = "Flame3", ObjectId = 1110},
			MapFlagSetFalse {Name = "mf_ChangeFlame3"},
		},
	...
	OnEvent
	{
		...
		Actions = 
		{
			ObjectChange	{Tag = "Flame3", ObjectId = 1113},
			MapFlagSetFalse {Name = "mf_ChangeFlame3"},
		},
	...
	OnEvent
	{
		...
		Actions = 
		{
			ObjectChange	{Tag = "Flame3", ObjectId = 1112},
			MapFlagSetFalse {Name = "mf_ChangeFlame3"},
		},
