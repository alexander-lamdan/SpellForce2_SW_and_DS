State
{
	...
	OnOneTimeEvent
	{
		Conditions =
		{
			AvatarValueIsEqual{Name = "av_P312_MosaicOfDeath", Value = 1},
		},
		Actions =
		{
	...
	OnOneTimeEvent
	{
		Conditions =
		{
			AvatarValueIsEqual{Name = "av_P312_MosaicOfDeath", Value = 2},
		},
		Actions =
		{
	...
	OnOneTimeEvent
	{
		Conditions =
		{
			AvatarValueIsEqual{Name = "av_P312_MosaicOfDeath", Value = 3},
		},
		Actions =
		{
