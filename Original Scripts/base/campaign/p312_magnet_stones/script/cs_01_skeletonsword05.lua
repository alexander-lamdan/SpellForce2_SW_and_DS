...
{	
	...
	OnEvent
	{
		...
		Conditions = 
		{
			MapFlagIsTrue {Name = "mf_CS_01_Anim_Start_SkeletonSword05"},
			EntityFlagIsFalse {Name = "ef_AnimPlay"},
			EntityFlagIsFalse {Name = "ef_Stop_It"},
		},
		Actions = 
		{
			FigureAnimPlayOnce	{Tag = "default", File = "base/gfx/figures/npc/figure_undead_skeleton_warrior_attack_1h_right_2.ska"}, -- 1.42s
