...
{	
	...
	OnEvent
	{
		...
		Conditions = 
		{
			MapFlagIsTrue {Name = "mf_CS_01_Anim_Start_SkeletonLance03"},
			EntityFlagIsFalse {Name = "ef_AnimPlay"},
			EntityFlagIsFalse {Name = "ef_Stop_It"},
		},
		Actions = 
		{
			FigureAnimPlayOnce	{Tag = "default", File = "base/gfx/figures/npc/figure_undead_skeleton_warrior_attack_2h_staff_1.ska"}, -- 2.00s
