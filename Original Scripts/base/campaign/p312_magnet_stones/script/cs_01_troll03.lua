...
{	
	...
	OnEvent
	{
		...
		Conditions = 
		{
			MapFlagIsTrue {Name = "mf_CS_01_Anim_Start_Troll03"},
			EntityFlagIsFalse {Name = "ef_AnimPlay"},
			EntityFlagIsFalse {Name = "ef_Stop_It"},
		},
		Actions = 
		{
			FigureAnimPlayOnce	{Tag = "default", File = "base/gfx/figures/fraction_2/figure_troll_smasher_attacktwohand2.ska"}, -- 3.00s
