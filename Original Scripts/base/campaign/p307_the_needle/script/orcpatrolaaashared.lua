...
GoalPoint1X = 270.119 + (math.random(6)-3)
GoalPoint1Y = 262.815 + (math.random(6)-3)
GoalPoint2X = 244.782 + (math.random(6)-3)
GoalPoint2Y = 335.36 + (math.random(6)-3) 
GoalPoint3X = 321.922 + (math.random(6)-3)
GoalPoint3Y = 190.654 + (math.random(6)-3)
GoalPoint4X = 358.189 + (math.random(6)-3)
GoalPoint4Y = 232.845 + (math.random(6)-3)
GoalPoint5X = 304.335 + (math.random(6)-3)
GoalPoint5Y = 345.507 + (math.random(6)-3)
