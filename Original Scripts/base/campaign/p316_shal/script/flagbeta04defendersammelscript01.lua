...
State
{
	...
	OnFigureRespawnEvent
	{
		...
		Actions = 
		{
			FigureRunToEntity	{TargetTag = "InvisibleBoxFlagBeta04"},
			EntityFlagSetFalse	{Name = "ef_CasterHoldPosition"},
		},
		DeathActions = 
		{
	...
	OnEvent
	{
		Conditions =
		{
			FigureIsInEntityRange	{Tag = "FlagBeta01Defender07", TargetTag = "InvisibleBoxFlagBeta04", Range = 8},
			FigureIsInEntityRange	{Tag = "FlagBeta01Defender08", TargetTag = "InvisibleBoxFlagBeta04", Range = 8},
			FigureIsInEntityRange	{Tag = "FlagBeta01Defender09", TargetTag = "InvisibleBoxFlagBeta04", Range = 8},
			EntityFlagIsFalse	{Name = "ef_CasterHoldPosition"},
		},
		Actions =
		{
			FigureHoldPosition	{Tag = "FlagBeta04Defender07"},
			FigureHoldPosition	{Tag = "FlagBeta04Defender08"},
			FigureHoldPosition	{Tag = "FlagBeta04Defender09"},
