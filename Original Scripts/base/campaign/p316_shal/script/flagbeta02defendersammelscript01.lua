...
State
{
	...
	OnFigureRespawnEvent
	{
		...
		Actions = 
		{
			FigureRunToEntity	{TargetTag = "InvisibleBoxFlagBeta02"},
			EntityFlagSetFalse	{Name = "ef_CasterHoldPosition"},
		},
		DeathActions = 
		{
	...
	OnEvent
	{
		Conditions =
		{
			FigureIsInEntityRange	{Tag = "FlagBeta01Defender07", TargetTag = "InvisibleBoxFlagBeta02", Range = 8},
			FigureIsInEntityRange	{Tag = "FlagBeta01Defender08", TargetTag = "InvisibleBoxFlagBeta02", Range = 8},
			FigureIsInEntityRange	{Tag = "FlagBeta01Defender09", TargetTag = "InvisibleBoxFlagBeta02", Range = 8},
