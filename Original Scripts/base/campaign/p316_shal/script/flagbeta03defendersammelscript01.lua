...
State
{
	...
	OnFigureRespawnEvent
	{
		...
		Actions = 
		{
			FigureRunToEntity	{TargetTag = "InvisibleBoxFlagBeta03"},
			EntityFlagSetFalse	{Name = "ef_CasterHoldPosition"},
		},
		DeathActions = 
		{
	...
	OnEvent
	{
		Conditions =
		{
			FigureIsInEntityRange	{Tag = "FlagBeta01Defender01", TargetTag = "InvisibleBoxFlagBeta03", Range = 8},
			FigureIsInEntityRange	{Tag = "FlagBeta01Defender02", TargetTag = "InvisibleBoxFlagBeta03", Range = 8},
			FigureIsInEntityRange	{Tag = "FlagBeta01Defender03", TargetTag = "InvisibleBoxFlagBeta03", Range = 8},
			EntityFlagIsFalse	{Name = "ef_CasterHoldPosition"},
		},
		Actions =
		{
			FigureHoldPosition	{Tag = "FlagBeta03Defender01"},
			FigureHoldPosition	{Tag = "FlagBeta03Defender02"},
			FigureHoldPosition	{Tag = "FlagBeta03Defender03"},
