...
State
{
	...
	OnFigureRespawnEvent
	{
		...
		Actions = 
		{
			FigureRunToEntity	{TargetTag = "InvisibleBoxAlpha03"},
			EntityFlagSetFalse	{Name = "ef_CasterHoldPosition"},
		},
		DeathActions = 
		{
	...
	OnEvent
	{
		Conditions =
		{
			...
			FigureIsInEntityRange	{Tag = "FlagAlpha03Defender09", TargetTag = "InvisibleBoxAlpha03", Range = 8},
			EntityFlagIsFalse	{Name = "ef_CasterHoldPosition"},
		},
		Actions =
		{
			
			FigureHoldPosition	{Tag = "FlagAlpha03Defender09"},
