...
HomePointUndeadCitizenSquad05X = 288
HomePointUndeadCitizenSquad05Y = 266

ZielPointUndeadCitizenSquad05X = 313
ZielPointUndeadCitizenSquad05Y = 360
   ...
   OnEvent
	{
		Conditions =
		{
			...
			FigureIsInRange	{Range = 5, X = HomePointUndeadCitizenSquad05X, Y = HomePointUndeadCitizenSquad05Y},
		},
		Actions =
		{
			FigureRun	{X = ZielPointUndeadCitizenSquad05X, Y = ZielPointUndeadCitizenSquad05Y},
		},
	},	
   ...
   --Respawn solange der Schutzkreis aktiviert ist	
 		OnFigureRespawnEvent
	{
		...
		Conditions = 
		{
			...
			BuildingIsAlive	{Tag = "SpawnBuilding47"},
		},
		Actions = 
		{
