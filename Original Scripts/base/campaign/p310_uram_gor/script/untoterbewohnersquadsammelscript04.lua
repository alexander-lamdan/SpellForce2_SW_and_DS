...
HomePointUndeadCitizenSquad04X = 354
HomePointUndeadCitizenSquad04Y = 484

ZielPointUndeadCitizenSquad04X = 302
ZielPointUndeadCitizenSquad04Y = 481
   ...
   OnEvent
	{
		Conditions =
		{
			...
			FigureIsInRange	{Range = 5, X = HomePointUndeadCitizenSquad04X, Y = HomePointUndeadCitizenSquad04Y},
		},
		Actions =
		{
			FigureRun	{X = ZielPointUndeadCitizenSquad04X, Y = ZielPointUndeadCitizenSquad04Y},
		},
	},	
   ...
   --Respawn solange der Schutzkreis aktiviert ist	
 		OnFigureRespawnEvent
	{
		...
		Conditions = 
		{
			...
			BuildingIsAlive	{Tag = "SpawnBuilding27"},
		},
		Actions = 
		{
