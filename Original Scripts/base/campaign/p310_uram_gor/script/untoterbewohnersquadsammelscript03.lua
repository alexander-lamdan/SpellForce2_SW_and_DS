...
HomePointUndeadCitizenSquad03X = 141
HomePointUndeadCitizenSquad03Y = 390

ZielPointUndeadCitizenSquad03X = 173
ZielPointUndeadCitizenSquad03Y = 371
   ...
   OnEvent
	{
		Conditions =
		{
			...
			FigureIsInRange	{Range = 5, X = HomePointUndeadCitizenSquad03X, Y = HomePointUndeadCitizenSquad03Y},
		},
		Actions =
		{
			FigureRun	{X = ZielPointUndeadCitizenSquad03X, Y = ZielPointUndeadCitizenSquad03Y},
		},
	},	
   ...
   --Respawn solange der Schutzkreis aktiviert ist	
 		OnFigureRespawnEvent
	{
		...
		Conditions = 
		{
			...
			BuildingIsAlive	{Tag = "SpawnBuilding50"},
		},
		Actions = 
		{
