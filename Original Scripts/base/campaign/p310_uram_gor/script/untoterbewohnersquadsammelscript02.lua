...
HomePointUndeadCitizenSquad02X = 201
HomePointUndeadCitizenSquad02Y = 407

ZielPointUndeadCitizenSquad02X = 189
ZielPointUndeadCitizenSquad02Y = 378
   ...
   OnEvent
	{
		Conditions =
		{
			...
			FigureIsInRange	{Range = 5, X = HomePointUndeadCitizenSquad02X, Y = HomePointUndeadCitizenSquad02Y},
		},
		Actions =
		{
			FigureRun	{X = ZielPointUndeadCitizenSquad02X, Y = ZielPointUndeadCitizenSquad02Y},
		},
	},	
   ...
   --Respawn solange der Schutzkreis aktiviert ist	
 		OnFigureRespawnEvent
	{
		...
		Conditions = 
		{
			...
			BuildingIsAlive	{Tag = "SpawnBuilding49"},
		},
		Actions = 
		{
