...
HomePointUndeadCitizenSquad01X = 123
HomePointUndeadCitizenSquad01Y = 264

ZielPointUndeadCitizenSquad01X = 109
ZielPointUndeadCitizenSquad01Y = 260
   ...
   OnEvent
	{
		Conditions =
		{
			...
			FigureIsInRange	{Range = 5, X = HomePointUndeadCitizenSquad01X, Y = HomePointUndeadCitizenSquad01Y},
		},
		Actions =
		{
			FigureRun	{X = ZielPointUndeadCitizenSquad01X, Y = ZielPointUndeadCitizenSquad01Y},
		},
	},	
   ...
   --Respawn solange der Schutzkreis aktiviert ist	
 		OnFigureRespawnEvent
	{
		...
		Conditions = 
		{
			...
			BuildingIsAlive	{Tag = "SpawnBuilding05"},
		},
		Actions = 
		{
