...
State
{
	...
	OnCutsceneFigureRespawnEvent	-- 
	{
		Conditions =
		{
			OR
			{
				MapFlagIsTrue	{Name = "mf_Cutscene_03bak"},
				AND
				{
					-- hier korrekte Startbedingungen eintragen
					MapFlagIsTrue {Name = "mf_P407_StartWeaponCS"},
		...
		Actions =
		{
			...
			CutsceneFigureTeleport {Tag = "pl_HumanAvatar", X = 614.707, Y = 100.105},
			FigureLookAtDirection {Tag = "pl_HumanAvatar", Direction = 30},
			CutsceneFigureTeleport {Tag = "pl_HumanNightsong", X = 613.615, Y = 103.156},
			FigureLookAtDirection {Tag = "pl_HumanNightsong", Direction = 25},
...
State
{
	...
	OnOneTimeEvent	-- Schattenlied02
	{
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "Schattenlied02", Tag = "pl_HumanNightsong"},
...
State
{
	...
	OnOneTimeEvent	-- Schattenlied03
	{
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "Schattenlied03", Tag = "pl_HumanNightsong"},
			FigureCutsceneTalkJobSet {Tag = "pl_HumanAvatar"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnCutsceneFigureDespawnEvent
	{
		...
		Actions =
		{
			...
			-- Avatar wird zurückteleportiert
			...
			-- Schattenlied wird zum Avatar teleportiert
			FigureTeleportToEntity	{Tag = "pl_HumanNightsong", TargetTag = "pl_HumanAvatar"},
			-- scriptingrelevante Flags
			MapFlagSetTrue {Name = "mf_P407_EndWeaponCS"},
		},
