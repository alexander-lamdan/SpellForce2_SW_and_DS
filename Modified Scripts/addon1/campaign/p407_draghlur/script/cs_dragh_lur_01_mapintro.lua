...
local _tRenderListWithShadowWarrior = CutsceneFigureRenderList{Tag = "pl_HumanAvatar"}
_tRenderListWithShadowWarrior.tModFuncs =
{
	Add =
	{
		"'ShadowWarrior'",
...
State
{
	...
	OnCutsceneFigureRespawnEvent	-- 
	{
		Conditions =
		{
			OR
			{
				...
				AND
				{
					...
					MapFlagIsTrue {Name = "mf_P407_StartIntroCS"},
		...
		Actions =
		{
			...
			CutsceneFigureTeleport {Tag = "pl_HumanAvatar", X = 408.449, Y = 654.894},
			FigureLookAtDirection {Tag = "pl_HumanAvatar", Direction = 0},
			CutsceneFigureTeleport {Tag = "Commander", X = 408.29, Y = 651.298},
			FigureLookAtDirection {Tag = "Commander", Direction = 180},
			CutsceneFigureTeleport {Tag = "ShadowWarrior", X = 410.302, Y = 650.168},
			FigureLookAtDirection {Tag = "ShadowWarrior", Direction = 210},
			-- Waffen werden nicht dargestellt
			CutsceneFigureWeaponsHide {Tag = "pl_HumanAvatar"},
			CutsceneFigureWeaponsHide {Tag = "Commander"},
			CutsceneFigureWeaponsHide {Tag = "ShadowWarrior"},
			-- Talkjobs werden gesetzt
			FigureCutsceneTalkJobSet {Tag = "pl_HumanAvatar"},
			FigureCutsceneTalkJobSet {Tag = "Commander"},
...
State
{
	...
	OnOneTimeEvent	-- Commander01
	{
		...
		Actions =
		{
			CutsceneSay {TextTag = "Commander01", Tag = "Commander"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Kamera zeigt kämpfende Blades und Dunkelelfen
	{
		Conditions =
		{
			CutsceneSayIsDone {},
...
State
{
	...
	OnOneTimeEvent	-- Commander02
	{
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "Commander02", Tag = "Commander"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Commander03
	{
		...
		Actions =
		{
			CutsceneSay {TextTag = "Commander03", Tag = "Commander"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Commander04
	{
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "Commander04", Tag = "Commander"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Schattenkrieger01 & Effekt auf Schattenkrieger
	{
		Conditions =
		{
			CutsceneSayIsDone {},
		...
		Actions =
		{
			EffectStart {Tag = "ShadowWarrior", File = "Effect_ShadowDestroyer_ML_Initial"},
			CutsceneSay {TextTag = "Schattenkrieger01", Tag = "ShadowWarrior"},
			EntityTimerStart {Name = "et_CStimerA"},
		},
	},
	OnOneTimeEvent	-- Schattenkrieger wird sichtbar
	{
		Conditions =
		{
			--CutsceneSayIsDone {},
...
State
{
	...
	OnOneTimeEvent	-- Schattenkrieger02
	{
		Conditions =
		{
			CutsceneSayIsDone {},
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "Schattenkrieger02", Tag = "ShadowWarrior"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnOneTimeEvent	-- Schattenkrieger03
	{
		Conditions =
		{
			CutsceneSayIsDone {},
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "Schattenkrieger03", Tag = "ShadowWarrior"},
			EntityTimerStart {Name = "et_CStimer"},
		},
...
State
{
	...
	OnCutsceneFigureDespawnEvent
	{
		...
		Actions =
		{
			...
			CutsceneFigureWeaponsShow {Tag = "Commander"},
			...
			MapFlagSetTrue {Name = "mf_P407_EndIntroCS"},
		},
