...
State
{
	...
	OnCutsceneFigureRespawnEvent	-- 
	{
		Conditions =
		{
			OR
			{
				...
				AND
				{
					...
					-- Avatar führt keine Dialog und die UI ist sichtbary
					AvatarIsNotTalking {},
		...
		Actions =
		{
			...
			CutsceneFigureTeleport {Tag = "pl_HumanAvatar", X = 347.849, Y = 389.836},
			FigureLookAtDirection {Tag = "pl_HumanAvatar", Direction = 0},
			CutsceneFigureTeleport {Tag = "pl_HumanHeroWind", X = 345.988, Y = 389.104},
			FigureLookAtDirection {Tag = "pl_HumanHeroWind", Direction = 0},
			CutsceneFigureTeleport {Tag = "pl_HumanHeroWhisper", X = 349.565, Y = 389.087},
			FigureLookAtDirection {Tag = "pl_HumanHeroWhisper", Direction = 0},
			CutsceneFigureTeleport {Tag = "pl_HumanHeroCaine", X = 345.889, Y = 392.573},
...
State
{
	...
	OnOneTimeEvent	-- CS01Wind01
	{
		Conditions =
		{
			...
			EntityTimerIsElapsed {Name = "et_CStimer", Seconds = 24},
		},
		Actions =
		{
...
State
{
	...
	OnOneTimeEvent	-- CS01Wisper02
	{
		...
		Actions =
		{
			...
			CameraTrackPlay {},
			CutsceneSay {TextTag = "CS01Wisper02", Tag = "pl_HumanHeroWhisper"},
			EntityTimerStart {Name = "et_CStimer"},
		},
