...
State
{
    ...
    OnToggleEvent
	{
		...
		OnActions = 
		{
			BuildingTeamTransfer{Tag = "BigRealTower01", Team = "tm_FriendlyTowers"},
		...
		OffActions = 
		{
			BuildingTeamTransfer{Tag = "BigRealTower01", Team = "tm_NeutralTowers"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			DialogSetDisabled{},
			FogOfWarRevealAtEntity	{FogOfWarId = 101, Tag = "BigRealTower01", Range = 10, Height = default},
		},
	},
