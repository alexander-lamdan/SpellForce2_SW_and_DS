--BlackPouderPosition
BarrelPosition01X = 582.4
BarrelPosition01Y = 505.4
BombJack = 1061
...
{	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2253, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 0, Tag = "Barrel05"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2213, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 90, Tag = "Bomb05"},
			EntityFlagSetTrue {Name = "ef_BombPlaced"},
			VisualTimerStart	{Seconds = 4},
			AvatarItemMiscTake	{Player = "pl_Human", ItemId = 283, Amount = 1},
			MapFlagSetTrue{Name = "mf_Bomb05set"},
		},	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectChange	{Tag = "Bomb05", ObjectId = 2212, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 90},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			MapFlagSetFalse{Name = "mf_Bomb05set"},
		},	
