...
{	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2253, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 0, Tag = "Barrel09"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2213, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 180, Tag = "Bomb09"},
			EntityFlagSetTrue {Name = "ef_BombPlaced"},
			VisualTimerStart	{Seconds = 4},
			AvatarItemMiscTake	{Player = "pl_Human", ItemId = 283, Amount = 1},
			MapFlagSetTrue{Name = "mf_Bomb09set"},
		},	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectChange	{Tag = "Bomb09", ObjectId = 2212, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 180},
			EntityFlagSetTrue {Name = "ef_BombExplode"},
		},	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			MapFlagSetFalse{Name = "mf_Bomb09set"},
		},	
