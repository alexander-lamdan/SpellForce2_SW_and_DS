...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track1Pony7", Range = 5},
	...
	Points = 
	{
		...
		--{Point = "07LStartPathPoint", WaitTime = 0, Range = 3},
        ...
        {Point = "PathPoint10",},
        {Point = "PathPoint11",},
        {Point = "Track1Stop13", WaitTime = 10},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "07LStartPathPoint", Range = 5},
			--MapFlagIsTrue	{Name = "mf_ResetTrack01"}, 
		},
	}, 
	StopActions = 
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track1Pony3", WaitTime = 0,Range = 3},
        ...
        {Point = "PathPoint13",},
        {Point = "PathPoint12",},
        {Point = "Track1_2Stopp13", WaitTime = 10},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track1Stop13", Range = 5},
			--MapFlagIsTrue	{Name = "mf_ResetTrack01"}, 
		},
	}, 
	StopActions = 
...
PathStates	
{
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track1Stop9", WaitTime = 0, Range = 3},
...
{	
	...
	OnEvent
	{
		Conditions =
		{
			...
			MapFlagIsFalse {Name = "mf_FollowStart"},
			FigureIsInEntityRange	{TargetTag = "Track1Pony7", Range = 15},
			--MapFlagIsFalse	{Name = "mf_Camp05Destroyed"}, 
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			...
			--MapFlagIsFalse	{Name = "mf_ResetTrack01"},
			MapFlagIsFalse {Name = "mf_FollowStart"},
			FigureIsInEntityRange	{TargetTag = "07LStartPathPoint", Range = 15},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			...
			--MapFlagIsFalse	{Name = "mf_ResetTrack01"},
			MapFlagIsFalse {Name = "mf_FollowStart"},
			FigureIsInEntityRange	{TargetTag = "Track1Stop13", Range = 15},
		},
		Actions =
		{
...
{	
	...
	OnEvent
	{
		Conditions =
		{
			MapTimerIsElapsed	{Name = "mt_FollowStartTimer", Seconds = 4.3},
