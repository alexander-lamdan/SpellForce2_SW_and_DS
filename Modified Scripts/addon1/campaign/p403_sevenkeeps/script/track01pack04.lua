...
PathStates	
{
	...
	Conditions = 
	{
		MapTimerIsElapsed	{Name = "mt_TrackStartSyncTimer", Seconds = 23},
	}, 
	Actions = 
	{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track1Pony4", Range = 5},
	...
	Points = 
	{
		...
		--{Point = "05RStartPathPoint", WaitTime = 0, Range = 3},
        ...
        {Point = "PathPoint10r",},
        {Point = "PathPoint11r",},
        {Point = "Track1Stop10", WaitTime = 10},
...
PathStates	
{
	...
	Conditions = 
	{
		MapTimerIsElapsed	{Name = "mt_TrackEndSyncTimer", Seconds = 23},
	}, 
	Actions = 
	{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "05RStartPathPoint", Range = 5},
			--MapFlagIsTrue	{Name = "mf_ResetTrack01"}, 
		},
	}, 
	StopActions = 
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track1Rider6", WaitTime = 0,Range = 3},
        ...
        {Point = "PathPoint13r",},
        {Point = "PathPoint12r",},
        {Point = "Track1_2Stopp10", WaitTime = 10},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track1Stop10", Range = 5},
			--MapFlagIsTrue	{Name = "mf_ResetTrack01"}, 
		},
	}, 
	StopActions = 
...
PathStates	
{
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track1Stop6", WaitTime = 0, Range = 3},
...
{	
	...
	OnEvent
	{
		Conditions =
		{
			...
			MapFlagIsFalse {Name = "mf_FollowStart"},
			FigureIsInEntityRange	{TargetTag = "Track1Pony4", Range = 15},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			...
			--MapFlagIsFalse	{Name = "mf_ResetTrack01"},
			MapFlagIsFalse {Name = "mf_FollowStart"},
			FigureIsInEntityRange	{TargetTag = "05RStartPathPoint", Range = 15},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			...
			--MapFlagIsFalse	{Name = "mf_ResetTrack01"},
			MapFlagIsFalse {Name = "mf_FollowStart"},
			FigureIsInEntityRange	{TargetTag = "Track1Stop10", Range = 15},
		},
		Actions =
		{
...
{	
	...
	OnEvent
	{
		Conditions =
		{
			MapTimerIsElapsed	{Name = "mt_FollowStartTimer", Seconds = 3.4},
