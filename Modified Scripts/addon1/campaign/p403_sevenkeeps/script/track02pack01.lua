...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track2PathEndpoint07", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	Points = 
	{
		...
		--{Point = "Track2PathPointStart01", WaitTime = 0, Range = 3},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track2PathPointStart01", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track2PathEndpoint03", WaitTime = 0, Range = 3},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track02CityWaitingPoint07", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	Points = 
	{
        ...
        {Point = "Track2PathPoint11l",},
        {Point = "Track2PathPoint12l",},
        {Point = "Track02CityWaitingPoint07",},
...
PathStates	
{
	...
	{
		DontTeleportToStartPosition = true,
        {Point = "Track02CityWaitingPoint03", WaitTime = 0, Range = 3},
...
{	
	...
	OnEvent
	{
		...
		{
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track2PathEndpoint07", Range = 15},
			--MapFlagIsFalse	{Name = "mf_Camp04Destroyed"}, 
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			MapFlagIsFalse	{Name = "mf_Camp04Destroyed"}, 
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track2PathPointStart01", Range = 15},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			MapFlagIsTrue	{Name = "mf_Camp04Destroyed"}, 
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track02CityWaitingPoint07", Range = 15},
		},
		Actions =
		{
...
{	
	...
	OnEvent
	{
		Conditions =
		{
			...
			--	FigureIsInEntityRange	{Tag = "Track02Lead", TargetTag = "SouthCamp", Range = 15},
			--},
			MapTimerIsElapsed	{Name = "mt_FollowTrack02StartTimer", Seconds = 2.4},
			FigureIsIdle	{},
