--BlackPouderPosition
BarrelPosition01X = 581
BarrelPosition01Y = 525
BombJack = 1061
...
{	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2253, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 0, Tag = "Barrel02"},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectSpawn	{ObjectId = 2213, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 0, Tag = "Bomb02"},
			EntityFlagSetTrue {Name = "ef_BombPlaced"},
			VisualTimerStart	{Seconds = 4},
			AvatarItemMiscTake	{Player = "pl_Human", ItemId = 283, Amount = 1},
			MapFlagSetTrue{Name = "mf_Bomb02set"},
		},	
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			ObjectChange	{Tag = "Bomb02", ObjectId = 2212, X = BarrelPosition01X, Y = BarrelPosition01Y, Direction = 0},
	...
	OnOneTimeEvent
	{
		...
		Actions =
		{
			...
			MapFlagSetFalse{Name = "mf_Bomb02set"},
		},	
