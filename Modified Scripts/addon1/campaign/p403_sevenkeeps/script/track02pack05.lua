...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track2PathEndpoint11", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	Points = 
	{
		...
		--{Point = "Track2PathPointStart05", WaitTime = 0, Range = 3},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track2PathPointStart05", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	{
		DontTeleportToStartPosition = true,
		{Point = "Track2PathEndpoint07", WaitTime = 0, Range = 3},
...
PathStates	
{
	...
	StopConditions =
	{
		OR
		{
			...
			FigureIsInEntityRange	{TargetTag = "Track02CityWaitingPoint11", Range = 5},
		},
	}, 
	StopActions = 
	{
	...
	Points = 
	{
        ...
        {Point = "Track2PathPoint11l",},
        {Point = "Track2PathPoint12l",},
        {Point = "Track02CityWaitingPoint11",},
...
PathStates	
{
	...
	{
		DontTeleportToStartPosition = true,
        {Point = "Track02CityWaitingPoint07", WaitTime = 0, Range = 3},
...
{	
	...
	OnEvent
	{
		...
		{
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track2PathEndpoint11", Range = 15},
			--MapFlagIsFalse	{Name = "mf_Camp04Destroyed"}, 
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			MapFlagIsFalse	{Name = "mf_Camp04Destroyed"}, 
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track2PathPointStart05", Range = 15},
		},
		Actions =
		{
	...
	OnEvent
	{
		Conditions =
		{
			MapFlagIsTrue	{Name = "mf_Camp04Destroyed"}, 
			MapFlagIsFalse {Name = "mf_FollowTrack02Start"},
			FigureIsInEntityRange	{TargetTag = "Track02CityWaitingPoint11", Range = 15},
		},
		Actions =
		{
...
{	
	...
	OnEvent
	{
		Conditions =
		{
			...
			--	FigureIsInEntityRange	{Tag = "Track02Lead", TargetTag = "SouthCamp", Range = 15},
			--},
			MapTimerIsElapsed	{Name = "mt_FollowTrack02StartTimer", Seconds = 3.6},
			FigureIsIdle	{},
