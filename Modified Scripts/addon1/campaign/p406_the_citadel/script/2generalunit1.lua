...
State
{
	...
	--Unit kehrt zur Basis zur�ck, wenn sich der ANgriffsbefehl ver�ndert hat.
	OnIdleGoHomeFake
  	{
  		UpdateInterval = 50,
  		X = GetEntityX(), Y = GetEntityY(),
  	...
  	}, -- wenn kein Auftrag, dann zur�ck zum Homepoint
...
--		}, -- Wenn Auftrag "Greif Torw�chter an", dann geh zum Torw�chter
--  	},
