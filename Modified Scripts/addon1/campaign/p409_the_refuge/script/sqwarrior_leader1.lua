...
State
{
	...
	OnFigureRespawnEvent
	{
		...
		Conditions = 
		{
			OR
			{
				MapFlagIsTrue	{Name = "mf_SQWarrior_SpawnLeader1Now"},
	...
	OnEvent
	{
		...
		Actions = 
		{
			MapFlagSetFalse	{Name = "mf_SQWarrior_SpawnLeader1Now"},
...
State	
{
	...
	OnEvent
	{
		...
		Actions = 
		{
			...
			--ObjectLootItemGenericAdd	{Tag = GetScriptTag() .. "_Reward", DropChance = 100, Level = 25, Skill = 0},
